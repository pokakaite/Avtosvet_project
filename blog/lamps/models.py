...
class Lamp(models.Model):
    ...
    offset = models.ForeignKey(Offset, on_delete=models.CASCADE, null=True, blank=True, default='', verbose_name='Смещение')
    length = models.ForeignKey(Length, on_delete=models.CASCADE, null=True, blank=True, default='', verbose_name='Длина')
    color = models.ForeignKey(Color, on_delete=models.CASCADE, null=True, blank=True, default='', verbose_name='Цвет')
